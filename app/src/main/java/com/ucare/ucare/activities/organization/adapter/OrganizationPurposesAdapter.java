 ...
 */
public class OrganizationPurposesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener  {
    ...
    public OrganizationPurposesAdapter(Context context) {
